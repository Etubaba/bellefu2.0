  ...
  return (
    <div>
      ...
      <div className="rounded-lg md:mt-5 mt-2 bg-bellefuWhite   h-auto w-full md:w-auto">
            ...
            >
                ...
                <div className=" ">
                  ...
                  <div className="flex sm:block justify-between">
                    ...
                    <span className=" md:hidden lg:hidden flex">
                      ...
                      <p className="font-semibold text-bellefuOrange">{order?.shipping_fee? order.shipping_fee:"pending"}</p>
                    </span>
                    <p className="font-semibold flex items-center md:hidden">
                      ...
                      <span className="">
                        {order?.product_quantity?order?.shipping_fee?((order?.price * order?.product_quantity) + order?.shipping_fee):`${order?.price * order?.product_quantity} + shipping fee`:0}
                      </span>
                    </p>
                  ...
                  <p className="flex space-x-2 text-[#FF5F00]">
                    <span className="text-sm md:text-lg">{moment(order?.orderTime).format("ll")}</span>
                  </p>
                  <div>
                    <button
              ...
              <div className="hidden md:inline-block">
                <div className="  flex-col items-end justify-end ">
                  ...
                  <p className={classNames("font-semibold mt-2",{"text-bellefuOrange": !order?.shipping_fee})}>{order?.shipping_fee? order.shipping_fee:"pending"}</p>
                  ...
                  >
                    <span className="flex item-center space-x-4">
                      ...
                      <span className="text-[8px] md:text-sm mt-1">
                        {order?.status === "processing" ? (
                          <MdHistoryToggleOff />
                        ) : order?.status === "ordered"? <MdCheck className="text-bellefuGreen text-2xl -mt-2" />:
                        <MdPayment />}{" "}
                      </span>
                    </span>
                  </button>
        ...
        <div>
          {showModal && currentOrderItem && <PaymentModal setShowModal={setShowModal} currentOrderItemIndex={currentOrderItemIndex} currentOrderItem={currentOrderItem} orderhistory={orderhistory}  setOrderHistory={setOrderHistory} />}
        </div>
      </div>
    </div>
  );
