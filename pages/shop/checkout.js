  ...
  return (
    <div className="mt-28">
      ...
      <div className="max-w-5xl mx-auto mt-8">
        <div className="mb-4 pl-3 md:pl-0 md:w-[70%] lg:w-full mx-auto">
          <button
            className="flex items-center space-x-1 hover:text-crystamolPink transition ease-in duration-100 hover:scale-125"
            onClick={() => router.back()}
          >
            <span>
              <FiArrowLeft />
