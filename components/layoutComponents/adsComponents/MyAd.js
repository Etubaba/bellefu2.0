...
import { BsFillEyeFill, BsCloudUpload } from "react-icons/bs";
        ...
        >
          ...
          >
            {({ getRootProps, getInputProps }) => (
              <div
                {...getRootProps()}
                className="border-dashed space-y-4 border-2 mx-4 md:mx-10 mb-4 md:my-5 flex flex-col border-gray-300 justify-center p-2 md:p-4  items-center "
              >
                <input {...getInputProps()} />
                <p>
